   ...
   <div className="LoginPage">
      ...
      {signUp && <div className="LoginPage__body">
          <Stack className="LoginPage__inputBody">
              ...
              <label className="LoginPage__label">
              Email
              <input className="LoginPage__input" name="useremail" value={newAccountCredentials.useremail} onChange={handleChangeNewAccount} onKeyDown={handleEnterNewAccount}/>
              </label>
              <label className="LoginPage__label">
              Password
              <input type="password" className="LoginPage__input" name="userpassword" value={newAccountCredentials.userpassword} onChange={handleChangeNewAccount} onKeyDown={handleEnterNewAccount}/>
              </label>
              ...
              <button className="LoginPage__submitButton" onClick={createUser} >Submit</button>
              <button className="LoginPage__submitButton">
                <Link className='LoginPage__link' to="/">
                  <MenuItem>Back</MenuItem>
                </Link>
              </button>
              <button className="LoginPage__submitButton" onClick={toggleSignup} >Log in
              </button>
          </Stack>
      </div>}
    </div>
